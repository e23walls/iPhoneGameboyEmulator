  ...
  int8_t * interruptsEnabled)
{
    ...
    switch (currentInstruction & 0x0F) {
        case 0:
            ...
            PRINTDBG("0x%02x -- SET 0,B -- B was 0x%02x; B is now 0x%02x\n", currentInstruction,
        ...
        case 1:
            ...
            PRINTDBG("0x%02x -- SET 0,C -- C was 0x%02x; C is now 0x%02x\n", currentInstruction,
        ...
        case 2:
            ...
            PRINTDBG("0x%02x -- SET 0,D -- D was 0x%02x; D is now 0x%02x\n", currentInstruction,
        ...
        case 3:
            ...
            PRINTDBG("0x%02x -- SET 0,E -- E was 0x%02x; E is now 0x%02x\n", currentInstruction,
        ...
        case 4:
            ...
            PRINTDBG("0x%02x -- SET 0,H -- H was 0x%02x; H is now 0x%02x\n", currentInstruction,
        ...
        case 5:
            ...
            PRINTDBG("0x%02x -- SET 0,L -- L was 0x%02x; L is now 0x%02x\n", currentInstruction,
        ...
        case 6:
            ...
            PRINTDBG("0x%02x -- SET 0,(HL) -- (HL) was 0x%02x; (HL) is now 0x%02x\n", currentInstruction,
        ...
        case 7:
            ...
            PRINTDBG("0x%02x -- SET 0,A -- A was 0x%02x; A is now 0x%02x\n", currentInstruction,
        ...
        case 8:
            ...
            PRINTDBG("0x%02x -- SET 1,B -- B was 0x%02x; B is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getB] & 0xff);
            break;
        case 9:
            ...
            PRINTDBG("0x%02x -- SET 1,C -- C was 0x%02x; C is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getC] & 0xff);
            break;
        case 0xA:
            ...
            PRINTDBG("0x%02x -- SET 1,D -- D was 0x%02x; D is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getD] & 0xff);
            break;
        case 0xB:
            ...
            PRINTDBG("0x%02x -- SET 1,E -- E was 0x%02x; E is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getE] & 0xff);
            break;
        case 0xC:
            ...
            PRINTDBG("0x%02x -- SET 1,H -- H was 0x%02x; H is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getH] & 0xff);
            break;
        case 0xD:
            ...
            PRINTDBG("0x%02x -- SET 1,L -- L was 0x%02x; L is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getL] & 0xff);
            break;
        case 0xE:
            ...
            PRINTDBG("0x%02x -- SET 1,(HL) -- (HL) was 0x%02x; (HL) is now 0x%02x\n", currentInstruction,
                     prev & 0xff, ram[(unsigned short)[state getHL_big]] & 0xff);
            break;
        case 0xF:
            ...
            PRINTDBG("0x%02x -- SET 1,A -- A was 0x%02x; A is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getA] & 0xff);
            break;
    }
};