  ...
  int8_t * interruptsEnabled)
{
    ...
    switch (currentInstruction & 0x0F) {
        case 0:
            ...
            PRINTDBG("0xCB%02x -- SET 6,B -- B was 0x%02x; B is now 0x%02x\n", currentInstruction,
        ...
        case 1:
            ...
            PRINTDBG("0xCB%02x -- SET 6,C -- C was 0x%02x; C is now 0x%02x\n", currentInstruction,
        ...
        case 2:
            ...
            PRINTDBG("0xCB%02x -- SET 6,D -- D was 0x%02x; D is now 0x%02x\n", currentInstruction,
        ...
        case 3:
            ...
            PRINTDBG("0xCB%02x -- SET 6,E -- E was 0x%02x; E is now 0x%02x\n", currentInstruction,
        ...
        case 4:
            ...
            PRINTDBG("0xCB%02x -- SET 6,H -- H was 0x%02x; H is now 0x%02x\n", currentInstruction,
        ...
        case 5:
            ...
            PRINTDBG("0xCB%02x -- SET 6,L -- L was 0x%02x; L is now 0x%02x\n", currentInstruction,
        ...
        case 6:
            ...
            PRINTDBG("0xCB%02x -- SET 6,(HL) -- (HL) was 0x%02x; (HL) is now 0x%02x\n", currentInstruction,
        ...
        case 7:
            ...
            PRINTDBG("0xCB%02x -- SET 6,A -- A was 0x%02x; A is now 0x%02x\n", currentInstruction,
        ...
        case 8:
            ...
            PRINTDBG("0xCB%02x -- SET 7,B -- B was 0x%02x; B is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getB] & 0xff);
            break;
        case 9:
            ...
            PRINTDBG("0xCB%02x -- SET 7,C -- C was 0x%02x; C is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getC] & 0xff);
            break;
        case 0xA:
            ...
            PRINTDBG("0xCB%02x -- SET 7,D -- D was 0x%02x; D is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getD] & 0xff);
            break;
        case 0xB:
            ...
            PRINTDBG("0xCB%02x -- SET 7,E -- E was 0x%02x; E is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getE] & 0xff);
            break;
        case 0xC:
            ...
            PRINTDBG("0xCB%02x -- SET 7,H -- H was 0x%02x; H is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getH] & 0xff);
            break;
        case 0xD:
            ...
            PRINTDBG("0xCB%02x -- SET 7,L -- L was 0x%02x; L is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getL] & 0xff);
            break;
        case 0xE:
            ...
            PRINTDBG("0xCB%02x -- SET 7,(HL) -- (HL) was 0x%02x; (HL) is now 0x%02x\n", currentInstruction,
                     prev & 0xff, ram[(unsigned short)[state getHL_big]] & 0xff);
            break;
        case 0xF:
            ...
            PRINTDBG("0xCB%02x -- SET 7,A -- A was 0x%02x; A is now 0x%02x\n", currentInstruction,
                     prev & 0xff, [state getA] & 0xff);
            break;
    }
};